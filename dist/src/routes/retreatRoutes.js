...
router.put("/update-retreat/:id", 
// verifyToken,
// authorizeRole(["admin", "organiser"]),
(0, asyncHandler_1.default)(retreatControllers_1.updateRetreat));
router.delete("/delete-retreat/:id", 
// verifyToken,
// authorizeRole(["admin"]),
(0, asyncHandler_1.default)(retreatControllers_1.deleteRetreat));
