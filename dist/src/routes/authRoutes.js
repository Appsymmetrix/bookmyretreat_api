...
router.post("/verify-email", (0, asyncHandler_1.default)(authControllers_1.verifyEmail));
router.post("/login", (0, asyncHandler_1.default)(authControllers_1.loginUser));
router.post("/add-image/:userId", (0, asyncHandler_1.default)(authControllers_1.addUserImages));
router.post("/resend-verification-email", (0, asyncHandler_1.default)(authControllers_1.resendVerificationEmail));
router.post("/resend-password-reset-email", (0, asyncHandler_1.default)(authControllers_1.resendPasswordResetEmail));
